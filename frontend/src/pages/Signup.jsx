...
const Signup = () => {
  ...
  return (
    <div className="text-white  py-11 w-full container">
      ...
      <div className="w-full h-[450px] bg-white pb-6 flex flex-col items-center justify-center ">
        <div>
          <form
          ...
          >
            ...
            <p className="text-[#5a5f73] text-[14px] mt-2">
              By signing up, you agree to CodePen's{" "}
              <Link className="text-[#36abf4]">Terms of Service</Link>,
              <Link className="text-[#36abf4]"> Code of Conduct</Link>, and
              <Link className="text-[#36abf4]"> Privacy Policy</Link>.{" "}
            </p>
          </form>
        </div>
        <div></div>
